...
%>
    ...
    <section class="ab-info-main py-5">
        <div class="container py-3">
            <h3 class="tittle text-center"><span class="sub-tittle"></span>Customer PROFILE</h3>
            <div class="row contact-main-info mt-5">
                <div class="col-md-12 contact-right-content">
                    <form action="customercontroller" method="post">
                        <input type="hidden" name="ID"  value=<%= c.getID() %>> 
                        <input type="text" name="yourname" value=<%= c.getYourname() %> required="">
                        <input type="email" class="email" name="email" value="<%= c.getEmail() %>" required="">
                        <input type="text" name="phone" placeholder="phone" value="<%= c.getPhone() %>" required="">
