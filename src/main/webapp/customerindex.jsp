...
if(session.getAttribute("data")!=null){
	c1 = (customermodel)session.getAttribute("data");
}
else{
			...
			<div class="container-fluid px-lg-5">
				...
				<nav class="py-4">
					...
					<ul class="menu mt-2">
						...
						</label> <a href="#"><%=c1.getYourname()  %>  <span class="fa fa-angle-down"
					...
					<ul class="menu mt-2">
						...
						<li>
							<!-- First Tier Drop Down --> <label for="drop-2" class="toggle">Drop
								Down <span class="fa fa-angle-down" aria-hidden="true"></span>
						</label> <a href="#">view prodcuts <span class="fa fa-angle-down"
								aria-hidden="true"></span></a> <input type="checkbox" id="drop-2" />
							<ul>
